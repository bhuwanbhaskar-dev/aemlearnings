...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe.skip('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/aemlearnings/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/aemlearnings',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/aemlearnings/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/aemlearnings/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/aemlearnings/' + theme + '/jcr:content?wcmmode=disabled';
    ...
    describe('DataLayer testing', () => {
        ...
        const templatePath = '/conf/aemlearnings/settings/wcm/templates/blank-af-v2';
